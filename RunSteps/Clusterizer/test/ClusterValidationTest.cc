...
public:
  ...
  explicit ClusterValidationTest(const edm::ParameterSet& conf);  
  virtual ~ClusterValidationTest();
...
/////////////////////////////////////////////////////////////////
// Contructor, empty.
ClusterValidationTest::ClusterValidationTest(edm::ParameterSet const& conf) 
...
void ClusterValidationTest::beginRun(const edm::EventSetup& iSetup) {
...
void ClusterValidationTest::analyze(const edm::Event& e, 
