...
output_file = os.path.dirname(os.path.realpath(sys.argv[1])) + '/../../Output/Validation.root'
...
# Analyzer
process.analysis = cms.EDAnalyzer('RunStepsValidation',
    rechit = cms.InputTag('siPixelRecHits'),
    rechitUsed = cms.bool(True),
    cluster = cms.InputTag('siPixelClusters'),
    clusterUsed = cms.bool(True),
    verbose = cms.int(0)                                    #Set this to 0 for no output, and 2 for detailed output!
)
