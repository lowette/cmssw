#ifndef RunSteps_Clusterizer_RunStepsRecHitizer_h
#define RunSteps_Clusterizer_RunStepsRecHitizer_h
...
namespace cms {
	...
	class RunStepsRecHitizer : public edm::EDProducer {

	public:
		explicit RunStepsRecHitizer(const edm::ParameterSet& conf);
    		virtual ~RunStepsRecHitizer();
