#ifndef RunSteps_Clusterizer_REALCLUSTERIZER1D_H
#define RunSteps_Clusterizer_REALCLUSTERIZER1D_H
...
class RealClusterizer1D : public PixelClusterizer {

public:
    typedef edm::DetSet<PixelDigi>::const_iterator DigiIterator;

    RealClusterizer1D(edm::ParameterSet const& conf);
