...
class RunStepsL1TriggerValidation : public edm::EDAnalyzer
{
  /// Public methods
  public:
    /// Constructor/destructor
    explicit RunStepsL1TriggerValidation(const edm::ParameterSet& iConfig);
...
//////////////
// CONSTRUCTOR
RunStepsL1TriggerValidation::RunStepsL1TriggerValidation(edm::ParameterSet const& iConfig) :
  config(iConfig)
{
...
//////////
// END JOB
void RunStepsL1TriggerValidation::endJob()//edm::Run& run, const edm::EventSetup& iSetup
{
  /// Things to be done at the exit of the event Loop
  std::cerr << " RunStepsL1TriggerValidation::endJob" << std::endl;
...
void RunStepsL1TriggerValidation::beginJob()
{
  ...
  std::cerr << " RunStepsL1TriggerValidation::beginJob" << std::endl;
...
//////////
// ANALYZE
void RunStepsL1TriggerValidation::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
