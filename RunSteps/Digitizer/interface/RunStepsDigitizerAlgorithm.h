#ifndef RunStepsDigitizerAlgorithm_h
#define RunStepsDigitizerAlgorithm_h
...
class RunStepsDigitizerAlgorithm  {
 public:
  RunStepsDigitizerAlgorithm(const edm::ParameterSet& conf, CLHEP::HepRandomEngine&);
  ~RunStepsDigitizerAlgorithm();
