...
process.load('RunSteps.Digitizer.NewConfiguration')
...
# Steps
print "==> DEFINE process.digitisation_step = cms.Path(process.pdigi) <=="
...
process.schedule = cms.Schedule(process.digitisation_step, process.digi2raw_step, process.L1TrackTrigger_step, process.L1TTAssociator_step, process.endjob_step, process.FEVTDEBUGoutput_step)

print "==> cust_phase2_BE5D <=="
